    ...
    T.defineMode("css", function (e, t) {
        ...
        var _ = {
            ...
            restricted_atBlock: function (e, t, r) {
                return "}" == e
                    ? ((r.stateArg = null), K(r))
                    : "word" == e
                    ? ((i = ("@font-face" == r.stateArg && !m.hasOwnProperty(t.current().toLowerCase())) || ("@counter-style" == r.stateArg && !g.hasOwnProperty(t.current().toLowerCase())) ? "error" : "property"), "maybeprop")
                    : "restricted_atBlock";
            },
        ...
        return {
            startState: function (e) {
                return { tokenize: null, state: r ? "block" : "top", stateArg: null, context: new j(r ? "block" : "top", e || 0, null) };
            },
            token: function (e, t) {
                ...
                var r = (
                    ...
                    function (e, t) {
                        ...
                        return "@" == r
                            ...
                            ? v(null, r)
                            : e.match(/^[\w-.]+(?=\()/)
                            ? (/^(url(-prefix)?|domain|regexp)$/i.test(e.current()) && (t.tokenize = z), (a = "variable"), "variable callee")
                            : /[\w\\\-]/.test(r)
            ...
            indent: function (e, t) {
                ...
                return (
                    (e = "prop" != e.type || ("}" != t && ")" != t) ? e : e.prev).prev &&
                        ("}" != t || ("block" != e.type && "top" != e.type && "interpolation" != e.type && "restricted_atBlock" != e.type)
                            ? ((")" != t || ("parens" != e.type && "atBlock_parens" != e.type)) && ("{" != t || ("at" != e.type && "atBlock" != e.type))) || (r = Math.max(0, e.indent - n))
                            : (r = (e = e.prev).indent)),
                    r
                );
            },
