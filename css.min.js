!(function (e) {
	...
	T.defineMode('css', function (e, t) {
		var a,
			...
			w =
				!1 !==
				e.highlightNonStandardPropertyKeywords;
		function v(e, t) {
			return (a = t), e;
		}
		function x(i) {
		...
		var _ = {
			top: function (e, t, r) {
				...
				if (
					/^@(font-face|counter-style)/i.test(e)
				)
					return (
						(r.stateArg = e),
			...
			restricted_atBlock_before: function (
				e,
				t,
				r,
			) {
