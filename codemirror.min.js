!(function (e, t) {
	...
	function ne(e, t, n, r) {
		e = M(e, t, n, r);
		return (
			e.setAttribute('role', 'presentation'), e
		);
	}
	function re(e, t) {
		if (
	...
	var fe = 50,
		...
		ge = {
			scroll: !(de.prototype.set = function (
				e,
				t,
			) {
				this.f = t;
	...
	function Ke(e) {
		var t =
			e._handlers && e._handlers.cursorActivity;
		if (t)
			for (
				var n =
	...
	var tt =
		...
		nt = window.getSelection
			...
			: function (e) {
					...
					try {
						t =
							e.ownerDocument.selection.createRange();
					} catch (e) {}
					return (
						!(!t || t.parentElement() != e) &&
						0 !=
	...
	(g.prototype.eol = function () {
		...
		(g.prototype.peek = function () {
			return (
				this.string.charAt(this.pos) || void 0
			);
		}),
		...
		(g.prototype.match = function (e, t, n) {
			...
			return i(
				this.string.substr(this.pos, e.length),
			) == i(e)
		...
		(g.prototype.hideFirstChars = function (
			e,
			t,
		) {
			this.lineStart += e;
	...
	(Mt.prototype.lookAhead = function (e) {
		...
		(Mt.prototype.save = function (e) {
			e =
				!1 !== e
					? ht(this.doc.mode, this.state)
					: this.state;
			return 0 < this.maxLookAhead
				? new Tt(e, this.maxLookAhead)
				: e;
		});
	...
	function Ut(e, t) {
		...
		var n =
				yt(e, t.from.line) &&
				W(e, t.from.line).markedSpans,
			e =
				yt(e, t.to.line) &&
				W(e, t.to.line).markedSpans;
		if (!n && !e) return null;
		var r = t.from.ch,
			i = t.to.ch,
			o = 0 == P(t.from, t.to),
		...
		for (var i = 0; i < t.changes.length; i++) {
			...
			if ('text' == o) {
				...
				s.text == s.node && (s.node = u.pre),
					s.text.parentNode.replaceChild(
						u.pre,
						s.text,
					),
					(s.text = u.pre),
					u.bgClass != s.bgClass ||
					u.textClass != s.textClass
						? ((s.bgClass = u.bgClass),
		...
		(e = e),
			...
			n.background
				? i
					...
					: (n.background.parentNode.removeChild(
							n.background,
						),
						(n.background = null))
				: i &&
	...
	function Mn(e) {
		...
		return n
			? (re(document.body, e.node) ||
				...
				(e.height =
					e.node.parentNode.offsetHeight))
			: 0;
	}
	function Nn(e, t) {
		for (
	...
	function An(e) {
		return (
			e.mover.offsetHeight -
			e.lineSpace.offsetHeight
		);
	}
	function Dn(e) {
		...
		if (t.cache.hasOwnProperty(l)) o = t.cache[l];
			...
			if (
				...
				if (
					...
					if (c) {
						...
						for (
							var d =
									a.text.firstChild.getClientRects(),
								f = 0;
							f < d.length - 1;
							f++
						) {
			...
			(o = (function (e, t, n, r) {
				...
				var g = p ? f[p - 1] : 0,
					...
					g = {
						left:
							('right' == u ? i.right : i.left) -
							t.rect.left,
						right:
							('left' == u ? i.left : i.right) -
							t.rect.left,
						top: g,
						bottom: m,
					};
	...
	function Xn(e) {
		return m && $
			? -(
					...
					parseInt(
						getComputedStyle(e.body).marginLeft,
					)
				)
	...
	function Yn(e) {
		return m && $
			? -(
					...
					parseInt(
						getComputedStyle(e.body).marginTop,
					)
				)
		...
		return function (e) {
			...
			if (e.widgets)
				for (var n = 0; n < e.widgets.length; n++)
					e.widgets[n].height &&
						(t += e.widgets[n].height);
			return o
				? t +
						(Math.ceil(e.text.length / l) || 1) *
							i
				: t + i;
		};
	}
	...
	function fr(e, t, n, r) {
		...
		if (
			!n &&
			'true' ==
				qe(t).getAttribute('cm-not-content')
		)
			return null;
		var o,
			l,
		...
		return (
			r &&
				0 < i.xRel &&
				(t = W(e.doc, i.line).text).length ==
					i.ch &&
				((n =
					S(t, t.length, e.options.tabSize) -
					t.length),
				(i = F(
					i.line,
					Math.max(
	...
	function wr(e, t) {
		...
		for (
			var s, a, u, c = 0;
			c < n.sel.ranges.length;
			c++
		)
			(!t && c == n.sel.primIndex) ||
				(s = n.sel.ranges[c]).from().line >=
					e.display.viewTo ||
	...
	function xr(e, t, n) {
		...
		(i.style.left = r.left + 'px'),
			...
			/\bcm-fat-cursor\b/.test(
				...
				((t =
					(t = Zn(e, t, 'div', null, null))
						.right - t.left),
				(i.style.width =
					(0 < t ? t : e.defaultCharWidth()) +
					'px')),
			r.other &&
				(((i = n.appendChild(
					M(
	...
	(Gr.prototype.update = function (e) {
			...
			r
				? ((this.vert.style.display = 'block'),
					...
					(this.vert.firstChild.style.height =
						Math.max(
							0,
							e.scrollHeight - e.clientHeight + t,
						) + 'px'))
		...
		(Gr.prototype.enableZeroWidthBar = function (
			n,
			r,
			i,
		) {
	...
	function Xr(n) {
		n.display.scrollbars &&
			...
			(n.display.scrollbars = new jr[
				n.options.scrollbarStyle
			](
				function (e) {
		...
		if (e) {
			var t = function (e) {
				...
				for (
					...
					(function (e) {
						...
						(i.mustUpdate =
							...
							null != i.scrollTop ||
							(i.scrollToPos &&
								(i.scrollToPos.from.line <
									l.viewFrom ||
									i.scrollToPos.to.line >=
										l.viewTo)) ||
							(l.maxLineChanged &&
						...
						d.maxLineChanged &&
							...
							((c.adjustWidthTo =
								En(
									h,
									d.maxLine,
									d.maxLine.text.length,
								).left + 3),
							(h.display.sizerWidth =
								c.adjustWidthTo),
							(c.barMeasure.scrollWidth =
								Math.max(
				...
				for (var f = 0; f < n.length; f++) {
					...
					p.preparedSelection &&
						g.display.input.showSelection(
							p.preparedSelection,
							m,
						);
					(!p.updatedDisplay &&
						p.startHeight == g.doc.height) ||
						Vr(g, p.barMeasure);
				...
				for (var v, y = 0; y < n.length; y++) {
					...
					null == x.wheelStartX ||
						(null == b.scrollTop &&
							null == b.scrollLeft &&
							!b.scrollToPos) ||
						(x.wheelStartX = x.wheelStartY =
							null);
					null != b.scrollTop &&
						zr(w, b.scrollTop, b.forceScroll);
					null != b.scrollLeft &&
						Rr(w, b.scrollLeft, !0, !0);
					b.scrollToPos &&
						((v = (function (e, t, n, r) {
							null == r && (r = 0),
								e.options.lineWrapping ||
						...
						(function (e, t) {
							...
							A(e, 'scrollCursorIntoView') ||
								...
								null == r ||
									...
									e.display.lineSpace.appendChild(
										o,
									),
									o.scrollIntoView(r),
					...
					x.wrapper.offsetHeight &&
						(C.scrollTop =
							w.display.scroller.scrollTop);
					b.changeObjs &&
						O(w, 'changes', w, b.changeObjs);
	...
	var Qr = function (e, t, n) {
		...
		(this.viewport = t),
			...
			(this.editorIsHidden =
				!r.wrapper.offsetWidth),
			(this.wrapperHeight =
				r.wrapper.clientHeight),
	...
	function Jr(e, t) {
			...
			i =
				...
				o <= c.viewFrom
					...
					: (c.viewFrom > i
							...
							: c.viewFrom < i &&
								(c.view = c.view.slice(pr(l, i))),
						(c.viewFrom = i),
						c.viewTo < o
							? (c.view = c.view.concat(
									mn(l, c.viewTo, o),
								))
							: c.viewTo > o &&
								(c.view = c.view.slice(
		...
		function p(e) {
			...
			return (
				x &&
				C &&
				s.display.currentWheelTarget == e
		...
		return (
			...
			(o = l) &&
				o.activeElt &&
				o.activeElt !=
					N(o.activeElt.ownerDocument) &&
				(o.activeElt.focus(),
				!/^(INPUT|TEXTAREA)$/.test(
					o.activeElt.nodeName,
				) &&
					o.anchorNode &&
	...
	function ei(e, t) {
		...
		t.signal(e, 'update', e),
			(e.display.viewFrom ==
				e.display.reportedViewFrom &&
				e.display.viewTo ==
					e.display.reportedViewTo) ||
				(t.signal(
					e,
					'viewportChange',
					e,
				...
				t.length != n.lineNumChars
					? ((r = (i = n.measure.appendChild(
						...
						(n.lineNumInnerWidth =
							Math.max(
								r,
								n.lineGutter.offsetWidth - i,
							) + 1),
						(n.lineNumWidth =
							n.lineNumInnerWidth + i),
			...
			if (r && !d && !K && null != i)
				return (
					n &&
						...
						Ir(
							e,
							Math.max(0, l.scrollTop + n * i),
						),
					Rr(
						e,
						Math.max(0, l.scrollLeft + r * i),
					),
					(n && !a) || D(t),
	...
	function bi(e, t) {
		for (
			...
			n.push(
				new G(yi(i.anchor, t), yi(i.head, t)),
			);
		}
	...
	function Ii(e, t, n) {
		for (var r = [], i = 0; i < e.length; ++i) {
			...
			if (o.ranges)
				r.push(
					n ? B.prototype.deepCopy.call(o) : o,
				);
			else {
				var l = o.changes,
					s = [];
	...
	function Ri(e, t, n, r, i) {
		null == i &&
			(i =
				e.cm && (e.cm.display.shift || e.extend)),
			U(
				e,
				new B([zi(e.sel.primary(), t, n, i)], 0),
				r,
			);
	}
	function Bi(e, t, n) {
	...
	function Ki(e, t, n) {
		(je(e, 'beforeSelectionChange') ||
			...
			r.cm &&
				O(r.cm, 'beforeSelectionChange', r.cm, o),
			(t =
				o.ranges != i.ranges
					? gi(
							r.cm,
		...
		for (var i, o = 0; o < t.ranges.length; o++) {
			var l = t.ranges[o],
				...
				s =
					l.head == l.anchor
						? a
						: _i(e, l.head, s && s.head, n, r);
			(!i && a == l.anchor && s == l.head) ||
				((i = i || t.ranges.slice(0, o))[o] =
					new G(a, s));
		}
			...
			if (
				...
				var i = e.cm,
					...
					f =
						...
						-1 < s.sel.contains(o.from, o.to) &&
							Ke(i),
						Li(s, o, l, hr(i)),
						i.options.lineWrapping ||
							(s.iter(
								d,
								u.line + o.text.length,
								function (e) {
									var t = on(e);
									t > a.maxLineLength &&
										((a.maxLine = e),
	...
	function fo(e, t, n) {
		rn(t) <
			((e.curOp && e.curOp.scrollTop) ||
				e.doc.scrollTop) && Wr(e, n);
	}
	...
	function mo(r, i, o, e, t) {
		...
		if (
			...
			d.readOnly &&
				((zt = !0),
				(r.history.done.length ||
					r.history.undone.length) &&
					r.clearHistory()),
			d.collapsed &&
				((d.id = ++go), (d.atomic = !0)),
			m)
	...
	(po.prototype.clear = function () {
		...
		(po.prototype.find = function (e, t) {
			...
			for (
				...
				if (
					null != l.from &&
					((n = F(t ? o : H(o), l.from)), -1 == e)
				)
					return n;
				if (
					null != l.to &&
					((r = F(t ? o : H(o), l.to)), 1 == e)
				)
					return r;
			}
		...
		xo =
			(((f.prototype = Se(co.prototype, {
				...
				addSelection: n(function (e, t, n) {
					...
					r.push(
						new G(E(this, e), E(this, t || e)),
					),
						U(
							this,
							gi(this.cm, r, r.length - 1),
							n,
						);
				}),
				getSelection: function (e) {
					for (
						var t = this.sel.ranges, n = 0;
						n < t.length;
						n++
					)
						var r = pt(
	...
	function Io(e, t, n) {
		...
		return (
			...
			(Z ? t.metaKey : t.ctrlKey) &&
				'Ctrl' != r &&
				(e = 'Ctrl-' + e),
			(Z ? t.ctrlKey : t.metaKey) &&
				'Mod' != r &&
				(e = 'Cmd-' + e),
			(e =
				!n && t.shiftKey && 'Shift' != r
					? 'Shift-' + e
					: e)
		);
	}
	...
	function Bo(t, e) {
		for (
			var n = t.doc.sel.ranges, r = [], i = 0;
			i < n.length;
			i++
		) {
			for (
				var o = e(n[i]);
				r.length && P(o.from, z(r).to) <= 0;
	...
	var jo = {
		...
		killLine: function (n) {
			return Bo(n, function (e) {
				var t;
				return e.empty()
					? ((t = W(n.doc, e.head.line).text
							.length),
						e.head.ch == t &&
						e.head.line < n.lastLine()
							? {
									from: e.head,
		...
		goLineLeftSmart: function (n) {
			return n.extendSelectionsBy(function (e) {
				var t =
						n.cursorCoords(e.head, 'div').top + 5,
					t = n.coordsChar(
						{ left: 0, top: t },
						'div',
					);
				return t.ch <
					n.getLine(t.line).search(/\S/)
					? Yo(n, e.head)
					: t;
			}, ve);
		},
	...
	function el(e) {
		...
		(e.target &&
			e.target != i.display.input.getField()) ||
		...
		A(c, e) ||
			...
			Nn(h, e)
				...
				: ul(c, e) ||
					...
					ue(c).focus(),
					1 == n &&
						c.state.selectingText &&
						c.state.selectingText(e),
					(t &&
						(function (n, e, r, t, i) {
							var o = 'Click';
							'double' == t
	...
	function al(e, t, n, r) {
		...
		if (
			i >=
			Math.floor(
				e.display.gutters.getBoundingClientRect()
					.right,
			)
		)
			return !1;
		...
		for (
			...
			if (
				a &&
				a.getBoundingClientRect().right >= i
			)
				return (
					O(
						e,
	...
	function ml(e) {
		e.options.lineWrapping
			...
			: (ee(e.display.wrapper, 'CodeMirror-wrap'),
				ln(e)),
			dr(e),
			I(e),
			jn(e),
	...
	function p(e, t) {
		...
		k(s.scroller, 'touchstart', function (e) {
			...
			k(s.wrapper, 'scroll', function () {
				return (s.wrapper.scrollTop =
					s.wrapper.scrollLeft =
						0);
			}),
			(s.dragFunctions = {
				enter: function (e) {
	...
	function xl(e, t, n, r, i) {
		var o = e.doc,
			l =
				...
				+new Date() - 200),
			s =
				'paste' == i || e.state.pasteIncoming > l,
			a = tt(t),
			u = null;
					...
					if (o.electricChars) {
						...
						o.electricInput &&
							o.electricInput.test(
								W(e.doc, i.head.line).text.slice(
									0,
									i.head.ch,
								),
							) &&
							(l = yl(e, i.head.line, 'smart'));
					l &&
						b(e, 'electricInput', e, i.head.line);
				}
			}
	}
	function Ll(e) {
		...
		for (
			'page' == r
				? ((i = Math.min(
					...
					(o =
						(0 < n ? t.bottom : t.top) + n * i))
				: 'line' == r &&
					(o = 0 < n ? t.bottom + 3 : t.top - 3);
			(l = tr(e, a, o)).outside;
	...
	function Ol(e, t) {
		...
		var r = W(e.doc, t.line),
			...
			r =
				(r &&
					(e =
						He(r, t.ch) % 2 ? 'right' : 'left'),
				Un(n.map, t.ch, e));
		return (
			(r.offset =
				'right' == r.collapse ? r.end : r.start),
			r
		);
	}
	function Al(e, t) {
	...
	function Dl(e, t, n) {
		...
		if (t == e.display.lineDiv) {
			if (!(r = e.display.lineDiv.childNodes[n]))
				return Al(
					e.clipPos(F(e.display.viewTo - 1)),
					!0,
				);
			(t = null), (n = 0);
		} else
	...
	(r.prototype.init = function (e) {
		...
		(r.prototype.screenReaderLabelChanged =
			function (e) {
				e
		...
		(r.prototype.showPrimarySelection =
			function () {
		...
		(r.prototype.showMultipleSelections =
			function (e) {
		...
		(r.prototype.forceCompositionEnd =
			function () {
				this.composing &&
					(clearTimeout(this.readDOMTimeout),
					(this.composing = null),
	...
	(i.prototype.init = function (n) {
		...
		n.wrapper.insertBefore(
			this.wrapper,
			n.wrapper.firstChild,
		),
			Y && (o.style.width = '0px'),
			k(o, 'input', function () {
				w &&
		...
		(i.prototype.screenReaderLabelChanged =
			function (e) {
				e
		...
		(i.prototype.poll = function () {
			...
			if (
				t.doc.sel == t.display.selForContextMenu
			) {
		...
		(i.prototype.onContextMenu = function (e) {
			...
			function d() {
				...
				o.contextMenuPending == d &&
					...
					w &&
						v < 9 &&
						s.scrollbars.setScrollTop(
							(s.scroller.scrollTop = c),
						),
					null != a.selectionStart &&
						((!w || v < 9) && h(),
						(e = 0),
						(t = function () {
							...
							'​' == o.prevInput
								? R(l, Zi)(l)
								: e++ < 10
									? (s.detectingSelectAll =
											setTimeout(t, 500))
									: ((s.selForContextMenu = null),
										s.input.reset());
						}),
						(s.detectingSelectAll = setTimeout(
							t,
							200,
						))));
			}
			u &&
				...
				x &&
					(t =
						a.ownerDocument.defaultView.scrollY),
				s.input.focus(),
				x &&
					a.ownerDocument.defaultView.scrollTo(
						null,
						t,
					),
				s.input.reset(),
		...
		o(
			...
			!1,
			function (e, t) {
				return (e.getInputField().autocorrect =
					t);
			},
			!0,
		),
		o(
			...
			!1,
			function (e, t) {
				return (e.getInputField().autocapitalize =
					t);
			},
			!0,
		),
		...
		o('readOnly', !1, function (e, t) {
			'nocursor' == t &&
				(Mr(e), e.display.input.blur()),
				e.display.input.readOnlyChanged(t);
		}),
		o('screenReaderLabel', null, function (e, t) {
			e.display.input.screenReaderLabelChanged(
				(t = '' === t ? null : t),
			);
		}),
		o(
		...
		(Fl.registerGlobalHelper = function (
			e,
			t,
			n,
			r,
			...
			Fl.registerHelper(e, t, r),
				El[e]._global.push({ pred: n, val: r });
		});
	var Il,
		zl =
