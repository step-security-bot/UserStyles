!(function (e, t) {
        ...
        if (o)
            for (var l = 0; l < o.length; ++l) {
                ...
                if (s.marker.collapsed) {
                    ...
                    if (
                        !((0 <= u && c <= 0) || (u <= 0 && 0 <= c)) &&
                        ((u <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= P(a.to, n) : 0 < P(a.to, n))) || (0 <= u && (s.marker.inclusiveRight && i.inclusiveLeft ? P(a.from, r) <= 0 : P(a.from, r) < 0)))
                    )
                        return 1;
                }
            }
    ...
    function hn(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            !(function (e, t, n) {
                ...
                o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = oe(o.styleClasses.bgClass, r.bgClass || "")), o.styleClasses.textClass && (r.textClass = oe(o.styleClasses.textClass, r.textClass || ""))),
                0 == r.map.length &&
                    r.map.push(
                        0,
                        0,
                        r.content.appendChild(
                            ((l = e.display.measure),
                            (o = void 0),
                            null == Qe && ((o = M("span", "​")), y(l, M("span", [o, document.createTextNode("x")])), 0 != l.firstChild.offsetHeight && (Qe = o.offsetWidth <= 1 && 2 < o.offsetHeight && !(w && v < 8))),
        ...
        if (t) {
            ...
            if (a.test(t))
                for (var c = document.createDocumentFragment(), h = 0; ; ) {
                    ...
                    var p = void 0;
                    "\t" == d[0]
                        ? ((f = (f = e.cm.options.tabSize) - (e.col % f)), (p = c.appendChild(M("span", we(f), "cm-tab"))).setAttribute("role", "presentation"), p.setAttribute("cm-text", "\t"), (e.col += f))
                        : ("\r" == d[0] || "\n" == d[0]
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (
                ...
                !e.options.lineNumbers ||
                    ...
                    (t.lineNumber = l.appendChild(M("div", bt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                i)
            )
    ...
    function zn(e, t) {
        var n,
            ...
            e =
                ...
                o || ((e = e), (r = H((n = Jt((n = t))))), ((n = e.display.externalMeasured = new gn(e.doc, n, r)).lineN = r), (r = n.built = hn(e, n)), (n.text = r.pre), y(e.display.lineMeasure, r.pre), (o = n)),
                Pn(o, t, i));
    ...
    function Rn(e, t, n, r, i) {
        ...
        if (t.cache.hasOwnProperty(l)) o = t.cache[l];
            ...
            (o = (function (e, t, n, r) {
                ...
                !(w && v < 9) || s || (i && (i.left || i.right)) || ((n = l.parentNode.getClientRects()[0]), (i = n ? { left: n.left, right: n.left + ar(e.display), top: n.top, bottom: n.bottom } : Gn));
    ...
    function _n(e, t, n, r, i) {
        ...
        return (
            ...
            ("page" != r && "window" != r) || ((i += (t = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : Yn(ae(e)))), (t = t.left + ("window" == r ? 0 : Xn(ae(e)))), (n.left += t), (n.right += t)),
            (n.top += i),
            (n.bottom += i),
            n
        );
            ...
            l =
                ...
                t >= o.viewTo
                    ...
                    ? (l = vr(e, t, t, -1))
                        ...
                        : mr(e)
                    : ((l = vr(e, t, t, -1)), (i = vr(e, n, n + r, 1)), l && i ? ((o.view = o.view.slice(0, l.index).concat(mn(e, l.lineN, i.lineN)).concat(o.view.slice(i.index))), (o.viewTo += r)) : mr(e)),
                o.externalMeasured);
    ...
    function Ar(e, t, n) {
        ...
        return (
            n &&
                n.ensure &&
                ((r = n.ensure.from.line), (n = n.ensure.to.line), r < i ? (o = vt(t, rn(W(t, (i = r))) + e.wrapper.clientHeight)) : Math.min(n, t.lastLine()) >= o && ((i = vt(t, rn(W(t, n)) - e.wrapper.clientHeight)), (o = n))),
    ...
    function Rr(e, t, n, r) {
        (t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth))),
            ((n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r) || ((e.doc.scrollLeft = t), ii(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t));
    }
    function Br(e) {
        var t = e.display,
            ...
            var t = function (e) {
                ...
                for (var n = e.ops, r = 0; r < n.length; r++) {
                    ...
                    (function (e) {
                        ...
                        (i.mustUpdate =
                            i.viewChanged || i.forceUpdate || null != i.scrollTop || (i.scrollToPos && (i.scrollToPos.from.line < l.viewFrom || i.scrollToPos.to.line >= l.viewTo)) || (l.maxLineChanged && o.options.lineWrapping)),
                ...
                for (var f = 0; f < n.length; f++) {
                    ...
                    null != p.adjustWidthTo &&
                        ((g.display.sizer.style.minWidth = p.adjustWidthTo + "px"), p.maxScrollLeft < g.doc.scrollLeft && Rr(g, Math.min(g.display.scroller.scrollLeft, p.maxScrollLeft), !0), (g.display.maxLineChanged = !1));
                ...
                if (a.line >= l.display.viewFrom) {
                    for (
                        var t = e.styles,
                            ...
                            r = r.classes,
                            i = (r ? (e.styleClasses = r) : n && (e.styleClasses = null), !t || t.length != e.styles.length || (n != r && (!n || !r || n.bgClass != r.bgClass || n.textClass != r.textClass))),
                            o = 0;
                        !i && o < t.length;
                        ++o
                    )
        ...
        return (
            ...
            (o = l) &&
                ...
                !/^(INPUT|TEXTAREA)$/.test(o.activeElt.nodeName) &&
                    ...
                    ((i = (c = o.activeElt.ownerDocument).defaultView.getSelection()), (c = c.createRange()).setEnd(o.anchorNode, o.anchorOffset), c.collapse(!1), i.removeAllRanges(), i.addRange(c), i.extend(o.focusNode, o.focusOffset))),
            te(n.cursorDiv),
            te(n.selectionDiv),
    ...
    function ei(e, t) {
        for (var n = t.viewport, r = !0; ; r = !1) {
            ...
            else if ((n && null != n.top && (n = { top: Math.min(e.doc.height + An(e.display) - Fn(e), n.top) }), (t.visible = Ar(e.display, e.doc, n)), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo)) break;
            if (!Jr(e, t)) break;
            Nr(e);
            var i = Br(e);
    ...
    function pi(e, t) {
        ...
        if ((r && s) || (n && a)) {
            ...
            n && null != i && ((a = (s = e.doc.scrollTop) + o.wrapper.clientHeight), (i = n * i) < 0 ? (s = Math.max(0, s + i - 50)) : (a = Math.min(e.doc.height, a + i + 50)), ti(e, { top: s, bottom: a })),
                ci < 20 &&
                    0 !== t.deltaMode &&
                    (null == o.wheelStartX
    ...
    function Di(e, t, n, r) {
        ...
        if (
            (l.lastOp == r || (l.lastOrigin == t.origin && t.origin && (("+" == t.origin.charAt(0) && l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500)) || "*" == t.origin.charAt(0)))) &&
            (o = (o = l).lastOp == r ? (Ai(o.done), z(o.done)) : o.done.length && !z(o.done).ranges ? z(o.done) : 1 < o.done.length && !o.done[o.done.length - 2].ranges ? (o.done.pop(), z(o.done)) : void 0)
        )
            (i = z(o.changes)), 0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? (i.to = vi(t)) : o.changes.push(Oi(e, t));
        else {
            var a = z(l.done);
            for ((a && a.ranges) || Hi(e.sel, l.done), o = { changes: [Oi(e, t)], generation: l.generation }, l.done.push(o); l.done.length > l.undoDepth; ) l.done.shift(), l.done[0].ranges || l.done.shift();
        }
    ...
    function Wi(e, t, n, r) {
        ...
        (a &&
            ...
            ((s.lastModTime == s.lastSelTime && s.lastOrigin == a) ||
                ...
                (o = z(s.done)),
                (l = t),
                "*" == (i = i.charAt(0)) || ("+" == i && o.ranges.length == l.ranges.length && o.somethingSelected() == l.somethingSelected() && new Date() - e.history.lastSelTime <= (e.cm ? e.cm.options.historyEventDelay : 500)))))
    ...
    function to(i, o, e) {
        ...
        if (!t || e) {
            ...
            if (u != s.length) {
                ...
                for (
                    var c = [], h = (Hi(r, a), a.push({ changes: c, generation: n.generation }), (n.generation = l.generation || ++n.maxGeneration), je(i, "beforeChange") || (i.cm && je(i.cm, "beforeChange"))), d = l.changes.length - 1;
                    0 <= d;
                    --d
                ) {
                    var f = (function (e) {
        ...
        if (t.to.line < e.first) no(e, t.text.length - 1 - (t.to.line - t.from.line));
            ...
            if ((((t = t.to.line > i ? { from: t.from, to: F(i, W(e, i).text.length), text: [t.text[0]], origin: t.origin } : t).removed = pt(e, t.from, t.to)), (n = n || bi(e, t)), e.cm)) {
                ...
                qr(i, 400),
                    ...
                    (d = je(i, "changes")),
                    ((s = je(i, "change")) || d) && ((l = { from: u, to: c, text: o.text, removed: o.removed, origin: o.origin }), s && b(i, "change", i, l), d && (i.curOp.changeObjs || (i.curOp.changeObjs = [])).push(l)),
            ...
            maybeSpill: function () {
                if (!(this.children.length <= 10)) {
                    ...
                    do {
                        ...
                        (e.parent ? ((e.size -= n.size), (e.height -= n.height), (t = L(e.parent.children, e)), e.parent.children.splice(t + 1, 0, n)) : ((((t = new co(e.children)).parent = e).children = [t, n]), (e = t)),
                        (n.parent = e.parent),
    ...
    function mo(r, i, o, e, t) {
        ...
        if (
            (d.replacedWith &&
                ((d.collapsed = !0), (d.widgetNode = ne("span", [d.replacedWith], "CodeMirror-widget")), e.handleMouseEvents || d.widgetNode.setAttribute("cm-ignore-events", "true"), e.insertLeft && (d.widgetNode.insertLeft = !0)),
            d.collapsed)
        ) {
                ...
                linkedDoc: function (e) {
                    for (
                        var t = this.first,
                            ...
                            n = (null != (e = e || {}).from && e.from > t && (t = e.from), null != e.to && e.to < n && (n = e.to), new f(gt(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction)),
                            r = (e.sharedHist && (n.history = this.history), (this.linked || (this.linked = [])).push({ doc: n, sharedHist: e.sharedHist }), (n.linked = [{ doc: this, isParent: !0, sharedHist: e.sharedHist }]), n),
                            i = yo(this),
                            o = 0;
                        o < i.length;
                        o++
    ...
    function el(e) {
        ...
        (e.target && e.target != i.display.input.getField()) ||
            ...
            A(i, e) ||
                ...
                18 != t || /\bCodeMirror-crosshair\b/.test(i.display.lineDiv.className) || (ie((r = i.display.lineDiv), "CodeMirror-crosshair"), k(document, "keyup", o), k(document, "mouseover", o))));
    }
    function tl(e) {
                ...
                : ul(c, e) ||
                  ...
                  (r = t
                      ? ((i = t),
                        (o = n),
                        (r = +new Date()),
                        ol && ol.compare(r, i, o) ? ((il = ol = null), "triple") : il && il.compare(r, i, o) ? ((ol = new rl(r, i, o)), (il = null), "double") : ((il = new rl(r, i, o)), (ol = null), "single"))
                      : "single"),
                  ue(c).focus(),
                      ...
                      (1 == n
                          ? t
                              ? ((i = c),
                                ...
                                (u = i.doc.sel),
                                (i.options.dragDrop && et && !i.isReadOnly() && "single" == l && -1 < (l = u.contains(o)) && (P((l = u.ranges[l]).from(), o) < 0 || 0 < o.xRel) && (0 < P(l.to(), o) || o.xRel < 0)
                                    ? function (t, n, r, i) {
                                          var o = t.display,
                                              l = !1,
                                              s = R(t, function (e) {
    ...
    function Nl(e, t, n, r) {
        ...
        for (
            "page" == r
                ? ((i = Math.min(e.display.wrapper.clientHeight, ue(e).innerHeight || s(e).documentElement.clientHeight)), (i = Math.max(i - 0.5 * sr(e.display), 3)), (o = (0 < n ? t.bottom : t.top) + n * i))
    ...
    (r.prototype.init = function (e) {
        ...
        (r.prototype.pollContent = function () {
            ...
            var e,
                ...
                r = r.to();
            if (
                (0 == i.ch && i.line > t.firstLine() && (i = F(i.line - 1, W(t.doc, i.line - 1).length)), r.ch == W(t.doc, r.line).text.length && r.line < t.lastLine() && (r = F(r.line + 1, 0)), i.line < n.viewFrom || r.line > n.viewTo - 1)
            )
                return !1;
            var o,
        ...
        (i.prototype.onContextMenu = function (e) {
            ...
            function h() {
                ...
                null != a.selectionStart &&
                    ((t = "​" + ((e = l.somethingSelected()) ? a.value : "")), (a.value = "⇚"), (a.value = t), (o.prevInput = e ? "" : "​"), (a.selectionStart = 1), (a.selectionEnd = t.length), (s.selForContextMenu = l.doc.sel));
            }
            function d() {
                var e, t;
        ...
        (Fl.prototype = {
            ...
            addWidget: function (e, t, n, r, i) {
                ...
                (t.style.position = "absolute"),
                    ...
                    n && ((r = this), (l = { left: u, top: a, right: u + t.offsetWidth, bottom: a + t.offsetHeight }), null != (l = Dr(r, l)).scrollTop && Ir(r, l.scrollTop), null != l.scrollLeft && Rr(r, l.scrollLeft));
            },
            ...
            getScrollInfo: function () {
                ...
                return { left: e.scrollLeft, top: e.scrollTop, height: e.scrollHeight - Wn(this) - this.display.barHeight, width: e.scrollWidth - Wn(this) - this.display.barWidth, clientHeight: Fn(this), clientWidth: Hn(this) };
            },
            ...
            swapDoc: t(function (e) {
                var t = this.doc;
                return (
                    (t.cm = null), this.state.selectingText && this.state.selectingText(), Ti(this, e), jn(this), this.display.input.reset(), Fr(this, e.scrollLeft, e.scrollTop), (this.curOp.forceScroll = !0), b(this, "swapDoc", this, t), t
                );
            }),
            phrase: function (e) {
