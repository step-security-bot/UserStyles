...
(function (mod) {
	...
	CodeMirror.defineMode(
		...
		function (config, parserConfig) {
			...
			var indentUnit = config.indentUnit,
				...
				documentTypes =
					parserConfig.documentTypes || {},
				mediaTypes =
					parserConfig.mediaTypes || {},
				mediaFeatures =
					parserConfig.mediaFeatures || {},
				mediaValueKeywords =
					parserConfig.mediaValueKeywords || {},
				propertyKeywords =
				...
				nonStandardPropertyKeywords =
					...
					{},
				fontProperties =
					parserConfig.fontProperties || {},
				counterDescriptors =
					parserConfig.counterDescriptors || {},
				colorKeywords =
					parserConfig.colorKeywords || {},
				valueKeywords =
				...
				highlightNonStandardPropertyKeywords =
					config.highlightNonStandardPropertyKeywords !==
					false;
			...
			function pass(type, stream, state) {
				return states[state.context.type](
					type,
					stream,
					state,
				);
			...
			states.top = function (
				...
				if (type == '{') {
					...
					/^@(font-face|counter-style)/i.test(
						type,
					)
				) {
					state.stateArg = type;
			...
			states.block = function (
				...
				if (type == 'word') {
					...
					if (
						...
						nonStandardPropertyKeywords.hasOwnProperty(
							word,
						)
					) {
						override =
			...
			states.atBlock = function (
				...
				if (type == 'word') {
					...
					if (
						...
						mediaValueKeywords.hasOwnProperty(
							word,
						)
					)
						override = 'keyword';
			...
			states.atComponentBlock = function (
				type,
				stream,
				state,
			) {
			...
			states.atBlock_parens = function (
				type,
				stream,
				state,
			) {
			...
			states.restricted_atBlock_before =
			...
			states.restricted_atBlock = function (
				type,
				stream,
				state,
			) {
			...
			return {
				...
				token: function (stream, state) {
					...
					override = style;
					if (type != 'comment')
						state.state = states[state.state](
							type,
							stream,
							state,
						);
	...
	var nonStandardPropertyKeywords_ = [
		...
		nonStandardPropertyKeywords = keySet(
