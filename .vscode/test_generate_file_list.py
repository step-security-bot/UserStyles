...
class TestGenerateFileList(unittest.TestCase):
    ...
    def test_should_ignore(self):
        ...
        self.assertTrue(should_ignore(
            'project/node_modules/package/', ignore_list))
        self.assertFalse(should_ignore(
            'project/src/utils/helper.py', ignore_list))
        ...
        self.assertFalse(should_ignore(
            'project/src/../src/main.py', ignore_list))
    ...
    def test_generate_file_list(self, mock_walk):
        ...
        self.assertEqual(generate_file_list(
            'root', ignore_list), expected_files)
    ...
    def test_calculate_luminance(self):
        ...
        self.assertAlmostEqual(
            calculate_luminance('#FF0000'), 54.213, places=2)
        ...
        def test_get_random_color(self, mock_randint):
            ...
            with patch('generate_file_list.MAX_ATTEMPTS', 100):
                with self.assertLogs('generate_file_list', level='DEBUG') as log:
                    ...
                    self.assertIn(
                        'DEBUG:generate_file_list:Generated color: #06c81c', log.output)

    @patch('generate_file_list.EXCLUDE_BRIGHT_COLORS', False)
    @patch('generate_file_list.ENSURE_READABLE_COLORS', False)
    ...
    def test_generate_file_list_with_links(self, mock_get_random_color):
        ...
        self.assertEqual(generate_file_list_with_links(
            file_list, repo_url), expected_html)
    ...
    def test_split_into_chunks(self):
        ...
        self.assertEqual(split_into_chunks(
            file_list_html, chunk_size), expected_chunks)
